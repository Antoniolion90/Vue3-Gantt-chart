    ...
    <el-popover
      ...
      <template #default>
        <div class="detail">
          <ul>
            <li>
              <span>Время отправления：</span><span>{{ startToString }}</span>
            </li>
            <li>
...
export default {
  ...
  mounted() {
    emitter.on('hideDetailInfo', this.hideDetailInfo)
    emitter.on('upzIndex', this.upZIndex)
  }
}
</script>
